...
Since no personal information is collected, we do not use your data for any purpose.
...
We do not store personal data, so there is no personal data at risk.

We use standard industry practices to protect app files and prevent unauthorized access.
...
Any changes will be posted here, and the effective date will be updated.
